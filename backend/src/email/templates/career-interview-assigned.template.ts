...
export const careerInterviewAssignedTemplate: TemplateBuilder = ({
  message,
  displayName,
}) => ({
  subject: 'Career interview scheduled — Confera',
  html: `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #444; font-size: 16px; line-height: 1.6;">
        Please log in to view the full details and confirm your availability.
      </p>
