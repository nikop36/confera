...
export const eventRegisteredTemplate: TemplateBuilder = ({
  message,
  displayName,
  eventId,
}) => ({
  subject: 'Registration confirmed — Confera',
  html: `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #444; font-size: 16px; line-height: 1.6;">
        Your spot is confirmed. You can view the full event details below.
