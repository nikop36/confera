...
export const roleApprovedTemplate: TemplateBuilder = ({
  message,
  displayName,
}) => ({
  subject: 'Your application has been approved — Confera',
  html: `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #444; font-size: 16px; line-height: 1.6;">
        You now have access to all the features available for your new role.
