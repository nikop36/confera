...
export const roleRejectedTemplate: TemplateBuilder = ({
  message,
  displayName,
}) => ({
  subject: 'Your application has been rejected — Confera',
  html: `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
      ...
      <p style="color: #444; font-size: 16px; line-height: 1.6;">
        If you believe there has been an error or would like to submit a new request,
        please log in and contact us.
      </p>
