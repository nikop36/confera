# Confera Documentation

This folder contains project documentation and diagram sources for the Confera conference networking system.

## Document Categories

- `UML/` - Existing use case diagram PDF.
- `Sequence diagram/` - Sequence diagrams for key system flows such as login, profile updates, AI matching, scheduling, and CSV import.
